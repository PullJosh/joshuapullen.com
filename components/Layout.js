          ...
          <div className="flex items-center justify-between">
            <Link href="/">
              <a className="flex items-center">
                <img
                  src="/images/josh-pullen-logo.webp"
                  alt=""
                  className="w-12 my-4 mr-4 rounded-full"
                />
              ...
              <Link href="/">
                <a
                  className={classNames(
                    "inline-block px-4 py-2 ml-2 rounded-md",
                    {
                      "hover:bg-gray-300": activeTab !== "home",
                      "bg-gray-800 text-white": activeTab === "home",
                    }
                  )}
                >
                  Start here
              ...
              <Link href="/blog/">
                <a
                  className={classNames(
                    "inline-block px-4 py-2 ml-2 rounded-md",
                    {
                      "hover:bg-gray-300": activeTab !== "blog",
                      "bg-gray-800 text-white": activeTab === "blog",
                    }
                  )}
                >
                  Blog
